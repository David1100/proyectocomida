            ...
            <div class="contenido_bebidas">
               ...
               <h3>Producto:</h3>
                <select class="form-control" name="producto" id="">
                   <option value="">Seleccione:</option>
                    <option value="Manzana Postobon">Manzana Postobon</option>
                    <option value="Uva Postobon">Uva Postobon</option>
               ...
               <h3>Tamaño:</h3>
                <select class="form-control" name="tamano" id="">
                   <option value="">Seleccione:</option>
                    ...
                    <option value="5000">2 L-$5000</option>
                </select>
                </div>
                 <div class="btn">
